...
Or, if you want to be adventurous, use the `moment` package from npm. Details of this excellent time/date handling library can be found here: http://momentjs.com/docs/
