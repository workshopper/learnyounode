Реалізуйте HTTP **сервер**, котрий повертає JSON-данні у відповідь на GET-запит за адресою '/api/parsetime'. Запит має містити в рядку запиту ключ 'iso' та час в ISO-форматі в якості значення.
