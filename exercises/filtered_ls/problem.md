...
Keep in mind that the first arguments of your program is not the first values of the `process.argv` array, as the first two values are reserved for system info. 
