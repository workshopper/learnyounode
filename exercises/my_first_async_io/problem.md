...
Instead of `fs.readFileSync()` you will want to use `fs.readFile()` and instead of using the return value of this method you need to collect the value from a [callback](https://github.com/maxogden/art-of-node#callbacks) function that you pass in as the second argument.
